...
import com.gustyflows.microservices.kafka.exception.KafkaClientException;
...
public class KafkaAdminClient {
    ...
    public KafkaAdminClient(KafkaConfigProperties kafkaConfigProperties, RetryConfigProperties retryConfigProperties, AdminClient adminClient, RetryTemplate retryTemplate, WebClient webClient) {
